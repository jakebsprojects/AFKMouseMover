...
def move_mouse_loop():
    ...
    root.after(5000, move_mouse_loop)
...
title_label = tk.Label(root, text="AFK Mouse Mover", font=("Helvetica", 16))
title_label.pack(pady=10)

# Add the notice label
notice_label = tk.Label(root, text="Click CTRL+ALT+X to start/stop the program", font=("Helvetica", 10))
